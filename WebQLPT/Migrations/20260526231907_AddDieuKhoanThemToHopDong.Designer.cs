...
namespace WebQLPT.Migrations
{
    ...
    [Migration("20260526231907_AddDieuKhoanThemToHopDong")]
    partial class AddDieuKhoanThemToHopDong
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasIndex("ChuTroId")
                        .IsUnique()
                        .HasFilter("[ChuTroId] IS NOT NULL");

                    b.HasIndex("KhachThueId")
                        .IsUnique()
                        .HasFilter("[KhachThueId] IS NOT NULL");
            ...
            modelBuilder.Entity("WebQLPT.Models.HopDong", b =>
                {
                    ...
                    b.Property<string>("DieuKhoanThem")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("User", b =>
                {
                    b.HasOne("WebQLPT.Models.ChuTro", "ChuTro")
                        .WithOne("User")
                        .HasForeignKey("User", "ChuTroId");

                    b.HasOne("WebQLPT.Models.KhachThue", "KhachThue")
                        .WithOne("User")
                        .HasForeignKey("User", "KhachThueId");
